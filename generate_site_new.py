...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .gallery-nav a { 
            padding: 10px 30px; color: #aaa; font-size: 0.85rem; text-transform: uppercase; letter-spacing: 2px; font-weight: 700;
        }
...
def generate_site():
    ...
    with open("index.html", "w") as f:
        ...
        <nav class="gallery-nav">
            ...
            <span style="color:#333; padding:10px">|</span>
        ...
        f.write("<footer><p>© 2025 " + SITE_TITLE + "</p></footer>")
        f.write("</div>")
    ...
    print("Success! Website generated using data from images.json.")
